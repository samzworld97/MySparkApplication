...
class PriceAdjustLoader {

    def priceAdjustLoader(prop: Properties, spark: SparkSession, LoaderName: String): Unit ={
      ...
      val priceAdjustFilePath = prop.getProperty("priceAdjustFilePath")
      ...
      try {
        ...
        dataframe = spark.read.format("csv")
          .option("inferschema","true").option("header","true").load(priceAdjustFilePath)
